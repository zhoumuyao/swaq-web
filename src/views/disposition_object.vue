      ...
      <el-card :body-style="{height: '75vh'}" style="margin: 10px 100px;position: relative;">
          ...
          <div class="object">
            <el-button class="objectBtn1" round plain type="info" @click="classEnviroment">
              <div>
                ...
                <div style="margin-top: 30px;">
                  <label style="font: 30px Extra large;">环境</label>
                </div>
              </div>
            </el-button>
          </div>
          ...
          <div style=" display: grid; grid-template-columns: 1fr 1fr 1fr; margin:50px 80px 0 80px">
            <div class="object">
              <el-button class="objectBtn2" round plain type="info" @click="classJump(1)">
                <div>
                  <label style="font: 20px Extra large;">染病个体</label>
                </div>
              </el-button>
            </div>
            <div class="object">
              <el-button class="objectBtn2" round plain type="info" @click="classJump(2)">
                <div>
                  <label style="font: 20px Extra large;">关联个体</label>
                </div>
              </el-button>
            </div>
            <div class="object">
              <el-button class="objectBtn2" round plain type="info" @click="classJump(3)">
                <div>
                  <label style="font: 20px Extra large;">尸体</label>
                </div>
              </el-button>
            </div>
            <el-dialog
            ...
            >
              <div style="text-align: center; margin-top: 20px;">
                <el-button
                  type="primary"
                  plain
                  style="width: 120px; height: 40px;margin-right: 50px;"
                  @click="judgeItem(true)"
                >是</el-button>
                <el-button
                  type="danger"
                  plain
                  style="width: 120px; height: 40px;"
                  @click="judgeItem(false)"
                >否</el-button>
              </div>
            </el-dialog>
          </div>
          ...
          <div style=" display: grid; grid-template-columns: 1fr 1fr; margin:50px 120px 0 120px">
            <div class="object">
              <el-button class="objectBtn3" round plain type="info" @click="classJump(4)">
                <div>
                  <label style="font: 20px Extra large;">其他物证</label>
                </div>
              </el-button>
            </div>
            <div class="object">
              <el-button class="objectBtn3" round plain type="info" @click="classJump(5)">
                <div>
                  <label style="font: 20px Extra large;">危险因子</label>
                </div>
              </el-button>
            </div>
            <el-dialog
              title="是否进行危险因子提取"
              v-model="riskfactorView"
              style="height: 200px; width: 30%; margin-top: 200px;"
            >
              <div style="text-align: center; margin-top: 20px;">
                <el-button
                  ...
                  plain
                  style="width: 120px; height: 40px;margin-right: 50px;"
                  @click="extractRiskfactor(true)"
                >是</el-button>
                <el-button
                  type="danger"
                  plain
                  style="width: 120px; height: 40px;"
                  @click="extractRiskfactor(false)"
                >否</el-button>
              </div>
            </el-dialog>
          </div>
        ...
        <div v-show="step == 1" style="height: 90%; margin: 10px; overflow:auto">
          ...
          <div class="next-button">
            ...
            <div
              v-show="objectClass == 1 || objectClass == 2 || objectClass == 3 || objectClass == 4"
            >
              <router-link :to="{ path: '/handle1' }">
                <el-button size="large" type="primary" style="width: 120px;">确认</el-button>
              </router-link>
