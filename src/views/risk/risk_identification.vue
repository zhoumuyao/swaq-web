                            ...
                            <div class="object">
                                <el-button class="objectBtn1" round plain type="info" @click="classPerson">
                                    <div>
                                        ...
                                        <div style="margin-top: 30px;"><label style="font: 30px Extra large;">人</label>
                                        </div>
                                    </div>
                                </el-button>
                            </div>
                            <div class="object">
                                <el-button class="objectBtn1" round plain type="info" @click="classItem">
                                    <div>
                                        ...
                                        <div style="margin-top: 30px;"><label style="font: 30px Extra large;">物证</label>
                                        </div>
                                    </div>
                                </el-button>
                            </div>
                            <div class="object">
                                <el-button class="objectBtn1" round plain type="info" @click="classEnviroment">
                                    <div>
                                        ...
                                        <div style="margin-top: 30px;"><label style="font: 30px Extra large;">疫源</label>
                                        </div>
                                    </div>
                                </el-button>
                            </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; height: 95%;">
                            ...
                            <div
                                ...
                                <el-form :model="form" label-width="auto"
                                    style="max-width: 600px;margin: 10px 0 0 20px; height: 95%;" size="large">
                                    <el-form-item>
                                        <label style="font-size: 16px;display: block; width: 200px;">采样种类：</label>
                                        <div style="width: 800px;">
                                            <el-select v-model="form.type" placeholder="请选择采样种类" size="large"
                                                style="width: 100%">
                                    ...
                                    <el-form-item>
                                        <label
                                            style="font-size: 16px; display: inline-block; width: 200px;">采样内容：</label>
                                    ...
                                    <el-form-item>
                                        ...
                                        <div style="width: 800px;">
                                            <el-select v-model="form.method" placeholder="请选择快检方法" size="large"
                                                style="width: 100%">
