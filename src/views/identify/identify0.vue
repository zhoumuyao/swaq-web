          ...
          <el-tab-pane label="样本采集及运输" name="first">
            ...
            <div style="  display: flex;justify-content: center;align-items: flex-start; margin-top: 2vh;">
              <el-card class="card_container">
                ...
                <div v-if="active1 === 2">
                  <!-- <span>样本采样基本要求 </span> -->
                  <div style="font-size: 20px;text-indent: 2em">针对确诊病例、可疑病例、密切接触者病例的采集，以及物品和环境监测的样本采集，都需要严格遵循特定的基本要求，以确保采集的样本安全、准确。以下是一般情况下的基本要求：</div>
                  <div v-for="(text, index) in text2" :key="index" style="margin-top: 1px;text-indent: 2em;font-size: 20px">{{ index + 1 }}、{{ text }}
                  </div>
                  <div style="font-size: 20px;text-indent: 2em">以上是一般情况下在生物危险现场采集各类样本时需要遵循的基本要求。针对具体病原体或疾病，可能会有一些特殊的要求，需要根据具体情况进行调整和遵循。</div>
                </div>
                <!-- 采集样本种类 -->
                <div v-if="active1 === 3">
                  <!-- <span style="font-size: 20px">采集样本种类 </span> -->
                  <div v-for="(text, index) in text3" :key="index" style="margin-top: 15px;font-size: 20px">{{ index + 1 }}、{{ text }}
                  </div>
                </div>
                <!-- 样本采集和处理 -->
                ...
                <div v-if="active1 === 5" class="center-container">
                  ...
                  <el-card style="width: 45%;height: 55vh;margin-right: 40px;">
                    ...
                    <div style="width: 100%;height: 50vh;">
                      <embed src="src/views/identify/PDF/SamplePackagingAndStorage..pdf" type="application/pdf" width="100%" height="100%">
                    </div>
              ...
              <el-card class="card_container">
                ...
                <div v-if="active2 === 0" class="center-container">
                  <el-card style="width: 45%;height: 55vh;margin-left: 40px;align-items: center;display: flex">
                    <img src="https://img.cjyun.org/a/10135/202008/ba7b58cda32e5665521a5e97aedc706b.jpeg" style="object-fit: cover; width: 100%; height: 100%;" alt="实验室生物安全">
