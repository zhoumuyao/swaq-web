              ...
              <el-card class="card_container">
                ...
                <div v-if="active1 === 0" class="center-container">
                  <el-card style="width: 45%;height: 55vh;margin-left: 40px;display: flex;justify-content: center;">
                    <!-- <label>显示图片</label> -->
                    <img src="https://img2.baidu.com/it/u=373455438,1378872333&fm=253&fmt=auto&app=138&f=JPEG?w=736&h=500" style="object-fit: cover; width: 100%; height: 100%;" alt="实验室生物安全">
              ...
              <el-card class="card_container">
                ...
                <div v-if="active2 === 0" class="center-container">
                  <el-card style="width: 45%;height: 55vh;margin-left: 40px;align-items: center;display: flex">
                    <img src="https://sc.sinaimg.cn/2012/0302/U5958P841DT20120302172051.jpg" style="object-fit: cover; width: 100%; height: 100%;" alt="实验室生物安全">
